...
public class RygcrawlTopFrame extends JFrame implements ActionListener 
{
	 ...
	 public void updateMenTable()
	   {
	      ...
	      model.setRowCount(5);
	      int row = 0;
	      for(Statistics s : this.s.getTopFiveMen("Rygcrawl", 100))
	      {
	   ...
	   public void updateWomenTable()
	   {
	      ...
	      int row = 0;
	      for(Statistics s : this.s.getTopFiveWomen("Rygcrawl", 100))
	      {
