...
public class CrawlTopFrame extends JFrame implements ActionListener 
{
	 ...
	 public void updateMenTable()
	   {
	      ...
	      model.setRowCount(5);
	      int row = 0;
	      for(Statistics s : this.s.getTopFiveMen("Crawl", 100))
	      {
	   ...
	   public void updateWomenTable()
	   {
	      ...
	      int row = 0;
	      for(Statistics s : this.s.getTopFiveWomen("Crawl", 100))
	      {
